      ...
      <>
        <ul className="space-y-1">
          {[
            ...
            "Everything summarized and clear",
          ].map((item) => (
            <li
              key={item}
          ...
          <li className="flex items-center gap-3 text-accent font-medium">
            ...
            Time & £&#39;s saved: equivalent of 1.5 years of university
          </li>
        </ul>
      </>
    ),
    ...
    description: (
      <>
        <ul className="space-y-2">
          {[
            "12 + Profesionally made designs",
            "Suites starting from £2,000 (depending on specific bathroom size)",
            "Go as is or mix and match design elements according to your taste ",
            "Photo realistic 3D renders to see how everything looks like - in a standard room layout",
            "Optional extra -> get the designed rendered in your exact room",
          ].map((item) => (
            <li
              key={item}
              className="flex items-center gap-3"
          ...
          <li className="flex items-center gap-3 text-accent font-medium">
            ...
            Time & £&#39;s saved: 10+ hours and £400+ (depending on your
            location)
          </li>
        </ul>
      </>
  ...
  },
  {
    ...
    description: (
      <>
        <ul className="space-y-2">
          {[
            "All products listed with links and prices - ready to purchase",
            "Everything you need to purchase and most likely don't yet know about",
            "Room measurement guide - text and video",
          ].map((item) => (
            <li
              key={item}
              className="flex items-center gap-3"
  ...
  },
  {
    ...
    description: (
      <>
        <ul className="space-y-2">
          {[
            "How to choose a contractor guide",
            "Where to find a contractor guide",
            "What to expect from your contractor - payment and time wise",
          ].map((item) => (
            <li
              key={item}
              className="flex items-center gap-3"
  ...
  },
  {
    ...
    description: (
      <>
        <ul className="space-y-2">
          {[
            "Went through the materials but still need some help?",
            "We offer phone support Monday-Friday, 09:00AM to 05:00PM",
            "We offer email support all week long, 24/7, although reply time might be slower",
          ].map((item) => (
            <li
              key={item}
              className="flex items-center gap-3"
  ...
  },
  {
    ...
    description: (
      <>
        <ul className="space-y-2">
          {[
            "Optional - Render your chosen design in YOUR bathroom",
            "Optional - Access trade discounts on your chosen products",
            "Optional - Work with a designer to create a custom design",
          ].map((item) => (
            <li
              key={item}
              className="flex items-center gap-3"
